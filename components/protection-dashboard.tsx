    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-muted-foreground">Advanced protection against MEV attacks and frontrunning</p>
        </div>
      </div>
      ...
      <Tabs defaultValue="analysis" className="space-y-6">
        ...
        <TabsContent value="analysis">
          <div className="space-y-6">
            <Card className="p-6">
              <h3 className="text-lg font-semibold mb-4">Demo Transaction Analysis</h3>
              <p className="text-sm text-muted-foreground mb-4">
                This demonstrates security analysis for a sample transaction. In production, this would analyze your
                actual swap parameters.
              </p>
              <div className="space-y-2 text-sm bg-muted/30 p-3 rounded">
                <div>
                  <strong>Transaction:</strong> {mockTransactionData.amountIn} {mockTransactionData.tokenIn} →{" "}
                  {mockTransactionData.tokenOut}
                </div>
                <div>
                  <strong>Slippage:</strong> {mockTransactionData.slippage}%
                </div>
                <div>
                  <strong>Route:</strong> {mockTransactionData.route.join(" → ")}
                </div>
              </div>
            </Card>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <div className="grid grid-cols-2 gap-4 text-sm">
                  <div className="space-y-1">
                    <span className="text-muted-foreground">Auto-enable for transactions &gt;</span>
                    <div className="font-mono">$10,000</div>
                  </div>
                  <div className="space-y-1">
                    <span className="text-muted-foreground">High-risk slippage threshold</span>
              ...
              <div className="pt-4 border-t">
                <p className="text-sm text-muted-foreground">
                  Protection settings can be customized based on your trading preferences and risk tolerance. Contact
